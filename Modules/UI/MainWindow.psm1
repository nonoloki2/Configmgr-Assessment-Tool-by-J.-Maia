    ...
    <Grid Margin="12">
        ...
        <Border Grid.Row="0" Background="#FFFFFF" BorderBrush="#D0D0D0" BorderThickness="1" CornerRadius="4" Padding="16" Margin="0,0,0,10">
            <Grid>
                ...
                <StackPanel Grid.Column="0">
                    ...
                    <TextBlock Name="txtVersion" Text="Version 1.1.0-alpha | Build 0005 | Professional Foundation" Margin="0,4,0,0" Foreground="#555"/>
        ...
        <Border Grid.Row="1" Background="#FFFFFF" BorderBrush="#D0D0D0" BorderThickness="1" CornerRadius="4" Padding="14" Margin="0,0,0,10">
            <Grid>
                ...
                <TextBlock Grid.Column="4" Name="txtCurrentTask" Text="Current task: Ready" VerticalAlignment="Center" Foreground="#555" TextTrimming="CharacterEllipsis"/>
                ...
                <Button Grid.Column="7" Name="btnExit" Content="Exit" Height="30"/>
            </Grid>
        </Border>
...
"@
    ...
    $names = 'txtVersion','txtAssessmentID','txtHeaderStatus','txtSiteCode','txtProvider','txtCurrentTask','btnDiscovery','btnExport','btnExit','sumServers','sumRoles','sumMP','sumDP','sumSUP','sumRP','treeTopology','progressBar','txtElapsed','gridResults','txtLog','txtDebug','statusLeft','statusLog','statusCsv'
    $ui = @{}
    ...
    $ui.btnDiscovery.Add_Click({
        try {
            ...
            $progressCb = { param($p,$task) $ui.progressBar.Value = $p; $ui.txtCurrentTask.Text = "Current task: $task"; $ui.statusLeft.Text = $task }
            ...
            $ui.txtCurrentTask.Text = 'Current task: Discovery completed successfully'
            $ui.txtDebug.Text = "AssessmentID: $($Session.AssessmentID)`r`nLogFile: $($Session.LogFile)`r`nCSV: $csv`r`nServers: $($Session.Inventory.Servers.Count)`r`nRoles: $($Session.Inventory.Roles.Count)"
        } catch {
