...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="ConfigMgr Assessment Tool by J. Maia" Height="660" Width="1180" MinHeight="560" MinWidth="900"
        ...
        <Border Grid.Row="0" Background="#FFFFFF" BorderBrush="#D0D0D0" BorderThickness="1" CornerRadius="4" Padding="16" Margin="0,0,0,10">
            <Grid>
                ...
                <StackPanel Grid.Column="0">
                    ...
                    <TextBlock Name="txtVersion" Text="Version 2.0.9-alpha | Build 0025 | Visible Native Window Controls Fix" Margin="0,4,0,0" Foreground="#555"/>
...
"@
    ...
    # Build 0025 safety guard: keep native Windows title bar/buttons visible even on low-height RDP sessions.
    # Previous builds used a fixed 780px height; on 768px displays the native title bar could open above the visible screen.
    ...
    try {
        ...
        $window.MaxHeight = [Math]::Max(500, ($workArea.Height - 40))
        $window.MaxWidth  = [Math]::Max(800, ($workArea.Width  - 40))
