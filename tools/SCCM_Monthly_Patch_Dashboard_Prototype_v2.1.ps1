...
<#
.SYNOPSIS
    SCCM Monthly Patch Dashboard - Prototype v2.1
...
.NOTES
    ...
    Prototype v2.1 includes Demo Mode so the interface and web report can be tested
...
<footer>Generated by SCCM Monthly Patch Dashboard Prototype v2.1</footer>
<script>
const data=[
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="SCCM Monthly Patch Dashboard - Prototype v2.1"
