...
<#
.SYNOPSIS
    SCCM Monthly Patch Dashboard - Prototype v2
...
.NOTES
    ...
    Prototype v2 includes Demo Mode so the interface and web report can be tested
...
<footer>Generated by SCCM Monthly Patch Dashboard Prototype v2</footer>
<script>
const data=[
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="SCCM Monthly Patch Dashboard - Prototype v2"
        ...
        <Border Grid.Row="2" Background="White" CornerRadius="14" BorderBrush="#D9E2EC"
            ...
            <Grid>
                ...
                <DataGrid x:Name="gridDeployments" Grid.Row="1" AutoGenerateColumns="False"
                          ...
                          RowHeight="32">
                    <DataGrid.Columns>
                        <DataGridTextColumn Header="Deployment name" Binding="{Binding Name}" Width="2.3*"/>
                        <DataGridTextColumn Header="Deployment ID" Binding="{Binding DeploymentID}" Width="115"/>
                        <DataGridTextColumn Header="Collection ID" Binding="{Binding CollectionID}" Width="110"/>
                        <DataGridTextColumn Header="Target collection" Binding="{Binding CollectionName}" Width="1.7*"/>
                        <DataGridTextColumn Header="Created" Binding="{Binding CreationTime}" Width="145"/>
                        <DataGridTextColumn Header="Deadline" Binding="{Binding Deadline}" Width="145"/>
                        <DataGridTextColumn Header="Success" Binding="{Binding Success}" Width="75"/>
                        <DataGridTextColumn Header="In progress" Binding="{Binding InProgress}" Width="85"/>
                        <DataGridTextColumn Header="Error" Binding="{Binding Error}" Width="65"/>
                        <DataGridTextColumn Header="Unknown" Binding="{Binding Unknown}" Width="75"/>
                    </DataGrid.Columns>
                </DataGrid>
...
$controls.btnGenerate.Add_Click({
    ...
    try {
        ...
        $controls.progress.Value = 0
        $controls.txtStatus.Text = "Report generation error: $($_.Exception.Message)"
        [System.Windows.MessageBox]::Show(
            $_.Exception.Message,
