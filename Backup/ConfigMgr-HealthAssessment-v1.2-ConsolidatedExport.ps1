...
function Invoke-Assessment {
    ...
    foreach ($grp in $serverGroups) {
        ...
        $overallStatus = Get-WorstStatus -Statuses @($overviewStatus,$osStatus,$storageStatus,$svcStatus,$mpStatus,$dpStatus)
...
function getSectionLabel(section){
  const labels={overview:'Overview',os:'Operating System',storage:'Storage',services:'Services',mp:'Management Point',dp:'Distribution Point'};
...
function Show-MainForm {
    ...
    $btnRun.Add_Click({
        ...
        $funcDefs = @(
            ...
            'Get-IISCertHealth','Get-MPComponentStatus','Get-ManagementPointHealth','Get-WSUSHealth','Get-StatusDotHtml','ConvertTo-FindingsTableHtml','Invoke-Assessment',
